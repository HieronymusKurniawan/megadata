...
class Admin extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['judul_halaman'] = 'Dashboard | Megadata';
    ...
    public function profile()
    {
        ...
        $data['judul_halaman'] = 'Profil Admin | Megadata';
        $data['admin'] = $this->AdminModel->asObject()->first();
    ...
    public function pegawai()
    {
        ...
        $data['menu'] = [
            'dashboard' => '',
            'pegawai' => 'show active', 'current-page',
            'jabatan' => '',
            'pengaturan_absen' => '',
            'absensi' => ''
        ];
        ...
        $data['judul_halaman'] = 'Data Pegawai | Megadata';
    ...
    public function tambah_pegawai()
    {
        ...
        $data['judul_halaman'] = 'Tambah Pegawai | Megadata';
    ...
    public function tambah_pegawai_()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('admin/tambah_pegawai')->withInput();
        }
    ...
    public function excel_pegawai()
    {
        ...
        foreach ($data as $baris => $kolom) {
            ...
            if ($baris != 0) {
                // AMBIL DATA DARI BARIS KEDUA DAN MENYIMPANNYA KEDALAM VARIABEL $data_pegawai
                if ($kolom[0] != null) {
    ...
    public function jabatan()
    {
        ...
        $data['menu'] = [
            'dashboard' => '',
            'pegawai' => '',
            'jabatan' => 'show active', 'current-page',
            'pengaturan_absen' => '',
            'absensi' => ''
        ];
        ...
        $data['judul_halaman'] = 'Data Jabatan | Megadata';
    ...
    public function tambah_jabatan()
    {
        ...
        $data['judul_halaman'] = 'Tambah Jabatan | Megadata';
        $data['admin'] = $this->AdminModel->asObject()->first();
    ...
    public function pengaturan_absen()
    {
        ...
        $data['menu'] = [
            ...
            'pegawai' => '',
            'jabatan' => '',
            'pengaturan_absen' => 'show active', 'current-page',
            'absensi' => ''
        ];

        $data['plugin'] = '';

        $data['judul_halaman'] = 'Setting Presensi | Megadata';
    ...
    public function absensi()
    {
        ...
        $data['judul_halaman'] = 'Data Presensi | Megadata';
    ...
    public function absen_hari_ini()
    {
        ...
        if ($absen_hari_ini != null) {
            // PRESENSI SUDAH DIBUAT
            session()->setFlashdata('pesan', "
                <script>
                    Swal.fire(
                        'Error!',
                        'Presensi hari ini sudah pernah dibuat!',
                        'error'
                    );
                </script>
            ");
        ...
        if ($pegawai == null) {
            ...
            session()->setFlashdata('pesan', "
                <script>
                    Swal.fire(
                        'Error!',
                        'Belum ada data pegawai, presensi tidak bisa dibuat!',
                        'error'
                    );
                </script>
            ");
    ...
    public function absen($kode_absen)
    {
        ...
        $data['plugin'] = '
            ...
            <script src="' . base_url('assets/template') . '/vendor/datatables/buttons.print.min.js"></script>	
        ';
        $tanggal = $this->AbsenModel->getByKode($kode_absen)->tgl_absen;
        $data['judul_halaman'] = 'Detail Presensi ' . $tanggal;
    ...
    public function absen_pegawai($kode_absen, $id_pegawai)
    {
        ...
        $data['judul_halaman'] = 'Data Presensi Pegawai | Megadata';
    ...
    public function izin_pegawai($kode_absen, $id_pegawai)
    {
        ...
        $data['judul_halaman'] = 'Data Izin Pegawai | Megadata';
