                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php if (strtotime(date('H:i', time())) >= strtotime($pengaturan->jam_keluar)) : ?>
                                    ...
                                    <button type="button" class="btn btn-success mt-2" onclick="take_picture();">Ambil Gambar</button>
                                <?php else : ?>
                                    <div class="alert alert-danger">Belum saatnya Presensi pulang</div>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
    ...
    <?php if ($absensi->absen_masuk == null) : ?>
        ...
        function take_picture() {
            Webcam.snap(function(data_url) {
                ...
                var tag_img = '<img src="' + data_url + '"/><br><button type="submit" class="btn btn-primary stripes-btn mt-2">Kirim Presensi</button>';
                $('#result').html(tag_img);
            });
