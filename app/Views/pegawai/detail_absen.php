                                ...
                                <?php if ($detail_absen->absen_masuk != null) : ?>
                                    ...
                                    <div class="col-lg-8 mt-1">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><span>Presensi Masuk: </span><?= date('H:i', $detail_absen->absen_masuk); ?></li>
                                ...
                                <?php if ($detail_absen->absen_keluar != null) : ?>
                                    ...
                                    <div class="col-lg-8 mt-1">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><span>Presensi Pulang: </span><?= date('H:i', $detail_absen->absen_keluar); ?></li>
                                            <li class="list-group-item">
                                                <span>Status Presensi: </span>
                                                <span class="badge bg-success">Sukses</span>
                                            </li>
