                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="row gutters">
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                            <img src="<?= base_url(); ?>/assets/img/pegawai/<?= $pegawai->gambar; ?>" class="img-fluid change-img-avatar" alt="Image" style="width: 170px; height: 125px;">
                                        </div>
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                                            <form action="<?= base_url('pegawai/profile_'); ?>" method="post" enctype="multipart/form-data">
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <input class="form-control" id="nip" type="text" name="nip" value="<?= $pegawai->nip; ?>" required>
                                                ...
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <input class="form-control" id="nama_pegawai" type="text" name="nama_pegawai" value="<?= $pegawai->nama_pegawai; ?>" required>
                                                ...
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <select class="select-single js-states" id="jenis_kelamin" name="jenis_kelamin" title="Select Product Category" data-live-search="true" value="<?= $pegawai->jenis_kelamin; ?>" required>
                                                ...
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <select class="form-select" id="jabatan" name="jabatan" title="Select Product Category" data-live-search="true" value="<?= $pegawai->nama_jabatan; ?>" required>
                                                        <?php foreach ($jabatan as $j) : ?>
                                                            <option value="<?= $j->id_jabatan; ?>" <?= $pegawai->id_jabatan == $j->id_jabatan ? 'selected' : null ?>>
                                                                <?= $j->nama_jabatan ?>
                                                ...
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <input class="form-control" id="alamat" type="text" name="alamat" value="<?= $pegawai->alamat; ?>" required>
                                                ...
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <input class="form-control" id="no_telepon" type="text" name="no_telepon" value="<?= $pegawai->no_telepon; ?>" required>
                                                ...
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <input class="form-control" type="email" id="email" name="email" value="<?= $pegawai->email; ?>" required>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('pegawai/password'); ?>" method="post">
                                ...
                                <label for="">Show Password</label>
                                <br>
                                <button class="btn btn-primary mb-3 mt-3">Save Settings</button>
                            </form>
                        </div>
                    </div>
