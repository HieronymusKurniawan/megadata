                ...
                <div class="col-xl-12">
                    ...
                    <div class="dashboard-header">
                        <div class="dashboard-header-content">
                            <img src="<?= base_url() ?>/assets/template/img/megadata.png" style="width: 140px; height: 80px; display:block; margin-left:auto; margin-right:auto;" alt="">
                            <!-- Welcome Title -->
                            <div class="welcome-title">
                                <h1>PRESENSI PEGAWAI MEGADATA
                                </h1>
                            </div>
