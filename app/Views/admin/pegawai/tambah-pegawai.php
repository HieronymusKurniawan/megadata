                            ...
                            <form action="<?= base_url('admin/tambah_pegawai_'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="text" name="nama_pegawai" value="<?= old('nama_pegawai'); ?>" required>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <div class="field-wrapper">
                                            ...
                                            <div class="field-placeholder">Password <span class="text-danger">*</span><br>
                                            </div>
                                        </div>
                                        <!-- Field wrapper end -->
                                        <input class="checkbox d-inline mb-3" type="checkbox" onclick="myFunction()">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <div class="field-wrapper">
                                            ...
                                            <textarea name="alamat" id="alamat" cols="30" rows="18" required><?= old('alamat'); ?></textarea>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <!-- Field wrapper start -->
                                        <div class="field-wrapper">
                                            <input class="form-control" type="file" name="gambar" id="input-foto" onchange="previewImg();" accept=".jpg, .jpeg, .png" value="<?= old('gambar'); ?>">
                                            <div class="field-placeholder">Gambar</div>
                                            <div class="form-text">
                                                Foto Pegawai.
                                            </div>
                                            <img src="<?= base_url('assets/img/pegawai'); ?>/default.jpg" class="img-thumbnail foto-pegawai" alt="Foto Pegawai" style="width: 90%;" value="<?= old('gambar'); ?>">
                                        </div>
                                        <!-- Field wrapper end -->
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="doc-block" style="padding: 13px;">
                                    <div class="doc-icon">
                                        <img src="<?= base_url('assets/template'); ?>/img/docs/xls.svg" alt="Doc Icon">
                                    </div>
