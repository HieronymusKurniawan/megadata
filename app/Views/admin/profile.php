                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="row gutters">
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                            <img src="<?= base_url(); ?>/assets/img/pegawai/<?= $admin->gambar; ?>" class="img-fluid change-img-avatar" alt="Image" style="width: 170px; height: 125px;">
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('admin/password'); ?>" method="post">
                                ...
                                <!-- Field wrapper end -->
                                <input class="checkbox" type="checkbox" onclick="myFunction3()">
                                <label for="">Show Password</label>
                                <br>
