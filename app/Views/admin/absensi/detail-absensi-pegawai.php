    ...
    <div class="content-wrapper-scroll">
        ...
        <div class="content-wrapper">
            ...
            <div class="row gutters">
                ...
                <h5>DETAIL PRESENSI <span style="text-transform: uppercase;"><?= $detail_absensi->nama_pegawai; ?></span></h5>
                                ...
                                <?php if ($detail_absensi->absen_masuk != null) : ?>
                                    ...
                                    <div class="col-lg-8 mt-1">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><span>Presensi Masuk: </span><?= date('H:i', $detail_absensi->absen_masuk); ?></li>
                                ...
                                <?php if ($detail_absensi->absen_keluar != null) : ?>
                                    ...
                                    <div class="col-lg-8 mt-1">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><span>Presensi Pulang: </span><?= date('H:i', $detail_absensi->absen_keluar); ?></li>
                                            <li class="list-group-item">
                                                <span>Status Presensi: </span>
                                                <span class="badge bg-success">Sukses</span>
                                            </li>
